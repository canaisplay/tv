...
##CONFIGURAÇÕES
####  TITULO DO MENU  #################################################################
title_menu = '[B][COLOR white]:::[/COLOR][COLOR white]BEM-VINDOS[/COLOR][COLOR white]:::[/COLOR][/B]'
###  DESCRIÇÃO DO ADDON ###############################################################
...
url_origem = 'https://raw.githubusercontent.com/canaisplay/menudoaddon/main/menuprincipal'
try:
...
def resolve_data(url):
    try:
        ...
        if 'CanaisPlay' in data:
            data = data.split('CanaisPlay')
